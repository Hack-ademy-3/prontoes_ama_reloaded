<section id="hero">
    ...
    <div class="hero-container">
        ...
        <div class="text-center php-email-form"><button type="submit" data-bs-toggle="modal"
                data-bs-target=".log-sign">Iniciar sesión o registrarme</button> </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="bs-example bs-example-tabs">
                        <ul id="myTab" class="nav nav-tabs">
                            <li id="tab1" class=" active tab-style login-shadow "><a href="#signin"
                                ...
                                <form class="form-horizontal">
                                    <fieldset>hbhb
                                        ...
                                        <div class="forgot-link">
                                            <a href="#forgot" data-toggle="modal" data-target="#forgot-password"> I
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <button id="signin" name="signin" class="btn btn-primary btn-block">Log
                                                    In</button>
                                            </div>
                                        </div>
                                    </fieldset>
